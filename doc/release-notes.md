Bitcoin Knots version 28.1.knots20250226 is now available from:

  <https://bitcoinknots.org/files/28.x/28.1.knots20250226/>
...
- AssumeUTXO mainnet parameters have been added for height 840,000. This means
  the new `loadtxoutset` RPC can be used only on mainnet with the matching UTXO
  set from that height. (#28553)
